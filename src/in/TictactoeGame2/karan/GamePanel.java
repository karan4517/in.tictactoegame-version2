 ...
 JFrame jf;
    ...
    public void actionPerformed(ActionEvent e) 
    {
       ...
       if(first_turn==true)
       {
           ...
           color1=Color.yellow;
           title_str="o";
           jf.setTitle(player2+" ("+title_str+") turn"); //main problem pakdi gyi thi
    ...
    else
          {
           ...
           color1=Color.red;
           title_str="x";
          jf.setTitle(player1+" ("+title_str+") turn"); //main problem pakdi gyi thi
    ...
    void restartGame()
    {
        ...
        if(i==0)
        {
           ...
           else
           {
              ...
              System.out.println("first turn : "+first_turn);
              jf.setTitle(player+" ("+str+") turn");
               win=false;
